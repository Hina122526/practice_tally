package com.hina122526.tally.adapter;
...
public class AccountAdapter extends BaseAdapter {
    ...
    class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            typeTv = view.findViewById(R.id.item_mainlv_tv_main);
            beizhuTv = view.findViewById(R.id.item_mainlv_tv_time);
            timeTv = view.findViewById(R.id.item_mainlv_tv_beizhu);
